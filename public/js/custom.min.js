var Gymove = function() {
    var e = $(window).width(),
        ...
        o = function() {
            if (jQuery(".dz-theme-mode").length > 0) {
                ...
                var e = getCookie("version");
                null != e && jQuery("body").attr("data-theme-version", e), jQuery(".dz-theme-mode").removeClass("active"), jQuery(window).on("resize", function() {
                    var e = getCookie("version");
                    null != e && jQuery("body").attr("data-theme-version", e)
                }), setTimeout(function() {
        ...
        c = function() {
            jQuery("#ckeditor").length > 0 && ClassicEditor.create(document.querySelector("#ckeditor"), {
                toolbar: {
                    items: ["heading", "|", "bold", "italic", "|", "fontfamily", "fontsize", "fontColor", "fontBackgroundColor", "strikethrough", "subscript", "superscript", "code", "|", "link", "uploadImage", "insertTable", "mediaEmbed", "|", "bulletedList", "numberedList", "outdent", "indent", "SelectAll", "Blockquote", "|", "undo", "redo", ]
                }
            }).then(e => {
                window.editor = e
            }).catch(e => {
    ...
    return {
        init: function() {
            t(), n(), a(), i(), s(), r(), d(), u(), m(), h(), f(), p(), v(), b(), g(), k(), C(), c(), l(), z(), x(), o()
        },
        load: function() {
            t(), n()
        },
